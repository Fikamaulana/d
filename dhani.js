...
reply(`${err}`)
	...
	Dhani.sendMessage(`${owner}@s.whatsapp.net`, `─────「 *ALERT-ERROR* 」─────\n\n\`\`\`${e}\`\`\`\n\n────────────────────`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "Developer TukulBot",body:"Jangan Lupa Subscribe Bot Dhani ?",previewType:"PHOTO",thumbnail:fs.readFileSync('./media/dhani.jpg'),sourceUrl:"https://wa.me/6285279774918"}}})
        }
	// console.log(e)
	}
}
